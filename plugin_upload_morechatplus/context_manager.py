    ...
    def build_system_prompt(
        ...
        lines = [
            ...
            "",
                        "",
            "## 可用工具（必须使用以下JSON格式调用）",
            "1. morechatplus_get_message(message_id: string) - 获取指定消息内容",
            "   示例: {\"name\": \"morechatplus_get_message\", \"arguments\": {\"message_id\": \"267518526\"}}",
            "2. morechatplus_get_user_profile(user_id: string) - 获取用户画像", 
            "   示例: {\"name\": \"morechatplus_get_user_profile\", \"arguments\": {\"user_id\": \"13286633\"}}",
            "3. morechatplus_query_nickname(nickname: string) - 查询昵称对应的用户",
            "   示例: {\"name\": \"morechatplus_query_nickname\", \"arguments\": {\"nickname\": \"小明\"}}",
            "4. morechatplus_get_context(count: number = 20) - 获取最近上下文",
            "   示例: {\"name\": \"morechatplus_get_context\", \"arguments\": {\"count\": 10}}",
            "5. morechatplus_add_nickname(user_id: string, nickname: string) - 添加用户昵称",
            "   示例: {\"name\": \"morechatplus_add_nickname\", \"arguments\": {\"user_id\": \"13286633\", \"nickname\": \"猫娘\"}}",
            "6. morechatplus_get_image_vision(image_id: string) - 获取图片识图结果",
            "   示例: {\"name\": \"morechatplus_get_image_vision\", \"arguments\": {\"image_id\": \"img_c72430bdf422415b\"}}",
            "",
